...
<title>会员管理系统</title>
<link rel="stylesheet" type="text/css" href="/ssm/js/jquery-easyui-1.4.1/themes/default/easyui.css" />
<link rel="stylesheet" type="text/css" href="/ssm/js/jquery-easyui-1.4.1/themes/icon.css" />
<script type="text/javascript" src="/ssm/js/jquery-easyui-1.4.1/jquery.min.js"></script>
<script type="text/javascript" src="/ssm/js/jquery-easyui-1.4.1/jquery.easyui.min.js"></script>
<script type="text/javascript" src="/ssm/js/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="/ssm/js/common.js"></script>
</head>
<body>
	<div>
    <table class="easyui-datagrid" id="userList" title="会员列表" 
	       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/ssm/user/list',method:'post',pageSize:5,toolbar:toolbar,pageList:[2,5,10]">
	    <thead>
	        <tr>
